...
## Valence & Tempo
Before we can cluster the works in to two (or potentially three) groups, we need to find out which audio features contain the most useful information. As already was mentioned in the previous section, valence seems to be a good indicator. Below is a plot of the distribution of the valence for each album. We can see that his first three albums sound positive (valence > 0.5) and the latter sound negative (valence < 0.5)
```{r, echo=FALSE}
